...
// Require the v3.12 SILO policy implementation even when a consuming module
// overrides Console's module replacement with another minio/pkg version.
var _ func(iampolicy.Resource) bool = iampolicy.Resource.IsBareARN
